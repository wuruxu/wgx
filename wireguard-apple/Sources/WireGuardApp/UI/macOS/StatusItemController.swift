...
class StatusItemController {
    ...
    private let statusBarImageWhenActive = NSImage(named: "WgxStatusBarLock")!
    private let statusBarImageWhenInactive = NSImage(named: "WgxStatusBarUnlock")!

    private let animationImages = [
        NSImage(named: "WgxStatusBarUnlock")!,
        NSImage(named: "WgxStatusBarTransition1")!,
        NSImage(named: "WgxStatusBarTransition2")!,
        NSImage(named: "WgxStatusBarLock")!
    ]
